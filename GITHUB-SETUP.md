# Publish version 0.3.0 on GitHub
...
5. Create tag **v0.3.0** against the main branch. Title the release **Heroic Character Creator v0.3.0 — Prototype**.
...
```text
https://github.com/jeremyrobertdavison/heroic-character-creator/releases/download/v0.3.0/module.json
https://github.com/jeremyrobertdavison/heroic-character-creator/releases/download/v0.3.0/heroic-character-creator.zip
```
...
If the repository already exists, upload the updated source, create a new **v0.3.0** release, and attach the new ZIP and manifest. Existing users can then use Foundry’s module update check. Keep the manifest asset named exactly `module.json`.
