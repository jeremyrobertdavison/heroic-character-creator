# Publish version 0.1.0 on GitHub
...
5. Create tag **v0.1.0** against the main branch. Title the release **Heroic Character Creator v0.1.0 — Prototype**.
...
```text
https://github.com/jeremyrobertdavison/heroic-character-creator/releases/download/v0.1.0/module.json
https://github.com/jeremyrobertdavison/heroic-character-creator/releases/download/v0.1.0/heroic-character-creator.zip
```
